...
- <kbd>🛫</kbd> Initial boilerplate code generation from my plugin template
...
- <kbd>📄TEMPLATE | </kbd>Code from the Template Repo, which is the starting point or merged into this repo to make updates easier.
...
- <kbd>🧹</kbd> or <kbd>🔧</kbd> Automated code formatting changes and fixes through common tools (`eslint --fix`, `fu.
- Code a linter has added or modified (formatting, imports, etc.)
