...
❯ Fix the project stucture to be like in the vue variant template (see commit `18314e05a7148bad1b437615a5dedd309dfb2167`), but for our current simple js project. Please do upgrade it to be TS
